			...
			<c:forEach var="title" items="${questionnaireList }">
				<div class="panel panel-success" style="text-align: center;">
				  <div class="panel-heading">
				  	...
				  	<a onclick="return checkSend();" href="${pageContext.request.contextPath}/questionnaire/doQuestionnaire.action?method=send&tid=${title.tid }" type="button" class="btn btn-info btn-xs" style="float: right;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span> 发布</a>
				  </div>
